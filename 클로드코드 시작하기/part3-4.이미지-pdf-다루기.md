...
> 🎨 **이미지 프롬프트**
> 깔끔한 플랫 벡터 일러스트, 부드러운 파스텔 톤에 옅은 청록(teal) 포인트, 흰 배경. 친근한 로봇 비서가 여러 장의 사진 카드와 PDF 문서 아이콘을 다루는 모습 — 한쪽에서 사진 이름표를 정리하고, 큰 파일을 작게 압축하고, PDF에서 텍스트를 뽑아내는 느낌. 깔끔하게 정돈되는 분위기. 이미지 안에 글자/텍스트는 절대 넣지 말 것.
