...
> 🎨 **이미지 프롬프트**
> 깔끔한 플랫 벡터 일러스트, 부드러운 파스텔 톤에 옅은 청록(teal) 포인트, 흰 배경. 한쪽에서 사람이 편안히 쉬거나 잠든 사이, 친근한 로봇 비서가 알람시계/달력 옆에서 정해진 시간에 맞춰 스스로 작업을 처리해 결과 문서를 만들어 두는 모습. '정해진 시간에 알아서 일하는 비서'. 이미지 안에 글자/텍스트는 절대 넣지 말 것.
