...
## 에이전틱 AI는 '박사학위까지 딴 신입사원'입니다

클로드코드 같은 에이전트의 성격을 한마디로 표현하면 이래요 — **박사학위까지 딴 신입사원.**

무슨 뜻이냐면,

- **전문성은 이미 최고 수준** — 기술 지식이나 업계 상식만 놓고 보면 웬만한 전문가입니다.
- **하지만 어디까지나 '신입사원'** — 우리 회사가 거쳐야 하는 절차, 우리 팀만의 방식, 그동안 쌓인 맥락처럼 **경험에서 나오는 인사이트가 없습니다.** 똑똑하지만, 우리 사정은 모르는 거죠.

그래서 결론은 분명합니다. **좋은 사수가 옆에서 하나하나 알려주면, 이 신입사원은 순식간에 에이스가 됩니다.** 그리고 그 사수가 바로 여러분이에요. "우리는 이렇게 일해", "결과는 이 폴더에 저장해", "이런 말투로 써줘" 하고 알려주면 클로드코드는 그걸 그대로 흡수합니다.

> 💡 그 '사수 노릇'을 제대로 하는 법이 이 과정의 **파트 4(나에게 맞게 길들이기)** 입니다. 지금은 "똑똑하지만 우리 사정은 아직 모르는 신입"이라는 점만 기억해두세요.
