...
> 🎨 **이미지 프롬프트**
> 깔끔한 플랫 벡터 일러스트, 부드러운 파스텔 톤에 옅은 청록(teal) 포인트, 흰 배경. 친근한 로봇 비서가 '되돌리기(undo)' 화살표를 누르자 흐트러졌던 서류가 이전 상태로 깔끔하게 돌아가고, 옆의 사람이 안도하며 미소 짓는 모습. 한쪽엔 원본 백업 사본이 안전하게 놓여 있는 느낌. '안심하고 되돌릴 수 있다'는 분위기. 이미지 안에 글자/텍스트는 절대 넣지 말 것.
...
<sub>◀ 이전 [결과 확인하고 다시 시키기](part2-3.결과-확인하고-다시-시키기) · [📑 목차](0.목차)</sub>
